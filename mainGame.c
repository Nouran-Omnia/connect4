...
void winner (char a[][2 * m + 1] , int n , int m){
    ...
    if(checkFreeSpaces (a , n , m) == 0)
    {
        ...
        if( pointsP1 > pointsP2 )
        {
            ...
            printf("\n\n\033[0;36m Player 1 , Please enter your name :\n ");
            fgets(name , max , stdin);                                       //problem1
        }
        else if( pointsP1 < pointsP2 )
        {
            printf("\n\033[1;33mplayer 2 wins %d - %d ", pointsP2 , pointsP1);
            printf("\n\n\033[0;36m Player 2 , Please enter your name :\n ");
            fgets(name , max , stdin);                                       // problem2
        }
        else
        {
            printf("\n\033[1;33mplayer 1 & player 2 got equal points %d - %d ", pointsP1 , pointsP2);
        }
    }
}
...
int main ()
{
    int i, j, k , p=1 ;
    cyan(0);
    printf("Welcome to \033[0;32mConnect 4 Game\033[0;36m \n\nplease enter the number of rows :\n");
    white(0);
    scanf("%d", &n);

    while(n<4){
        printf("\033[0;31m This is invalid , Please choose another number of rows :\n");
        scanf("%d", &n);
    }
    ...
    while(m<4){
        printf("\033[0;31m This is invalid , Please choose another number of columns :\n");
        scanf("%d", &m);
    }
